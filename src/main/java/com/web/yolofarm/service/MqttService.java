...
public class MqttService {
    ...
    public MqttService(MqttProperties properties, SimpMessagingTemplate messagingTemplate) throws MqttSecurityException, MqttException {
    ...
    public void startListening(String feed) throws Exception {
        ...
        try {
            CLIENT.subscribe(topic, (t, message) -> {
                ...
                messagingTemplate.convertAndSend("/topic/microbit/"+feed, payload);
